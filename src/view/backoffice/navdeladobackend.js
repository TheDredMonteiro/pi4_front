...
import logo from '../../assets/imgs/logo_cursar.png'
        ...
        <div className='col-12 col-sm-3 col-lg-2 col-sm-2 d-flex sticky-top px-0'  style={{ backgroundColor: "#D3D4A9" }}>
            ...
            <br />
                <div className=' text-center  w-100 mb-0 mb-sm-3' style={{ color: "#46483C", fontSize: "25px",textShadow: "3px 3px 5px #000000" }}>
                    <img className="photo" width={"70%"} height={"100%"} src={logo} alt="new" /></div>
                <ul id='menu' className='nav d-flex flex-row flex-sm-column h-100 w-100'>
                    ...
                    <li className='mb-2'>
                        <Link to='/back-office/livros'
                            ...
                            &nbsp;&nbsp;&nbsp;<i class="fs-5 bi bi-bar-chart-fill" style={{ color: "#46483C"}}></i> &nbsp;<span className=' d-none d-sm-inline fw-bold' style={{ color: "#46483C", fontSize: "20px" }}>Dashboard</span>
                        </Link>
                    </li>
                    <li className='mb-2'>
                        <Link to='/back-office/clientes'
                            className='btn btn-outline-secondary border-0 rounded-0 px-2 px-sm-0  d-flex'
                            onFocus={e => setTimeout(() => { e.target.blur() }, 200)}>
                            &nbsp;&nbsp;&nbsp;<i class="fs-5 bi bi-people-fill" style={{ color: "#46483C"}}></i> &nbsp;<span className=' d-none d-sm-inline fw-bold' style={{ color: "#46483C", fontSize: "20px" }}>Utilizadores</span>
                        </Link>
                    </li>
                    <li className='mb-2'>
                        <Link to='/back-office/estatisticas'
                            className='btn btn-outline-secondary border-0 rounded-0 px-2 px-sm-0  d-flex'
                            onFocus={e => setTimeout(() => { e.target.blur() }, 200)}>
                            &nbsp;&nbsp;&nbsp;<i class="fs-5 bi bi-geo-alt-fill" style={{ color: "#46483C"}}></i> &nbsp;<span className=' d-none d-sm-inline fw-bold' style={{ color: "#46483C", fontSize: "20px" }}>Ponto de Interesse</span>
                        </Link>
                    </li>
                    <li className='mb-2'>
                        <Link to='/back-office/estatisticas'
                            className='btn btn-outline-secondary border-0 rounded-0 px-2 px-sm-0  d-flex'
                            onFocus={e => setTimeout(() => { e.target.blur() }, 200)}>
                            &nbsp;&nbsp;&nbsp;<i class="fs-5 bi bi-map-fill" style={{ color: "#46483C"}}></i> &nbsp;<span className=' d-none d-sm-inline fw-bold' style={{ color: "#46483C", fontSize: "20px" }}>Regiões</span>
                        </Link>
                    </li>
                    <li className='mb-2'>
                        <Link to='/back-office/estatisticas'
