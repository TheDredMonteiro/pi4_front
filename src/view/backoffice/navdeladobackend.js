        ...
        <div className='col-12 col-sm-3 col-lg-2 col-sm-2 d-flex sticky-top px-0' style={{ backgroundColor: "#E9F3DE" }}>
            <div className='d-flex flex-sm-column flex-row flex-grow-1 align-items-center align-items-sm-start pt-2'>
                ...
                <div className=' text-center  w-100 mb-0 mb-sm-3' style={{ color: "#46483C", fontSize: "25px", textShadow: "3px 3px 5px #000000" }}>
                    <img className="photo" src={logo} alt="new" />
                    
                </div>
                <div className=' text-center  w-100 mb-0 mb-sm-3' style={{ color: "#46483C", fontSize: "25px"}}>
                ...
                <ul id='menu' className='nav d-flex flex-row flex-sm-column h-100 w-100'>
                    ...
                    <li className='mb-2'>
                    {(userrole == 1) &&
                            <Link to={'/backend/utilizadores/'+ 1}
                            className='btn btn-outline-secondary border-0 rounded-0 px-2 px-sm-0  d-flex'
                            onFocus={e => setTimeout(() => { e.target.blur() }, 200)}>
                    ...
                    <li className='mb-2'>
                    {(userrole == 1) &&
                            <Link to={'/backend/pontosinteresse/'+ 1}
                            className='btn btn-outline-secondary border-0 rounded-0 px-2 px-sm-0  d-flex'
                            onFocus={e => setTimeout(() => { e.target.blur() }, 200)}>
                            &nbsp;&nbsp;&nbsp;<i class="fs-5 bi bi-geo-alt-fill" style={{ color: "#46483C" }}></i> &nbsp;<span className=' d-none d-sm-inline fw-semibold' style={{ color: "#46483C", fontSize: "19px" }}>Pontos de Interesse</span>
                        </Link>
                        }
                        {(userrole == 2) &&
                           <Link to={'/backend/pontosinteresse/'+ 2}
                           className='btn btn-outline-secondary border-0 rounded-0 px-2 px-sm-0  d-flex'
                           onFocus={e => setTimeout(() => { e.target.blur() }, 200)}>
                           &nbsp;&nbsp;&nbsp;<i class="fs-5 bi bi-geo-alt-fill" style={{ color: "#46483C" }}></i> &nbsp;<span className=' d-none d-sm-inline fw-semibold' style={{ color: "#46483C", fontSize: "19px" }}>Pontos de Interesse</span>
                       </Link>
                        ...
                        {(userrole == 3) &&
                            <Link to={'/backend/pontosinteresse/'+ 3}
                            className='btn btn-outline-secondary border-0 rounded-0 px-2 px-sm-0  d-flex'
                            onFocus={e => setTimeout(() => { e.target.blur() }, 200)}>
                            &nbsp;&nbsp;&nbsp;<i class="fs-5 bi bi-geo-alt-fill" style={{ color: "#46483C" }}></i> &nbsp;<span className=' d-none d-sm-inline fw-semibold' style={{ color: "#46483C", fontSize: "19px" }}>Pontos de Interesse</span>
                        </Link>
